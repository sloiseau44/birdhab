package com.birdhab.document.infrastructure.db;
 ...
 * un Postgres réel (schéma "document"), sans démarrer le contexte Spring
 * complet (pas de sécurité, JWT, MinIO...) : cible uniquement la cohérence
 * entre les fichiers de migration et le schéma qu'ils produisent, le seul
 * point que les tests unitaires (repositories mockés) ne peuvent pas couvrir.
 *
