...
import com.birdhab.payment.api.dto.ErrorResponse;
 ...
 * avec le code HTTP attendu par {@code docs/api/payment.yml}.
 */
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(PaymentNotPaidException.class)
    public ResponseEntity<ErrorResponse> handlePaymentNotPaid(
            PaymentNotPaidException ex, HttpServletRequest request) {
